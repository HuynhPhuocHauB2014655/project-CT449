<template>
    <div class="content px-3 rounded border border-3" style="margin: 20px auto;">
        <div v-if="this.success" class="text-center border border-4 border-success">
        ...
        <Form v-else @submit="register" :validation-schema="userFormSchema"
            style="margin: 20px auto; background: #EFF7FF;" class="p-3 border rounded border-primary">
            ...
            <div class="row">
                <div class="col-sm">
                    <div class="row mb-4 mx-2 px-3 pt-3">
                        <label for="username" class="col-sm-6 col-form-label fw-bold">Mã đọc giả:</label>
                        <div class="col-sm">
                ...
                <div class="col-sm">
                    ...
                    <div class="row mb-4 mx-2 px-3 pt-3">
                        <label for="phai" class="col-sm-6 col-form-label fw-bold">Phái:</label>
                        <div class="col-sm">
